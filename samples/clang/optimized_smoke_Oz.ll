...
; Function Attrs: minsize nofree nounwind optsize ssp uwtable(sync)
define range(i32 0, 2) i32 @main() local_unnamed_addr #0 !dbg !12 {
    ...
    #dbg_value(i32 66, !20, !DIExpression(), !22)
  %1 = tail call i32 @putchar(i32 noundef 66) #2, !dbg !23
...
!20 = !DILocalVariable(name: "value", scope: !12, file: !8, line: 5, type: !21)
!21 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!22 = !DILocation(line: 0, scope: !12)
!23 = !DILocation(line: 6, column: 10, scope: !12)
!24 = !DILocation(line: 6, column: 30, scope: !12)
