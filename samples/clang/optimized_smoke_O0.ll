; ModuleID = 'samples/clang/optimized_smoke.c'
...
define i32 @main() #0 !dbg !12 {
  ...
  store i32 %6, ptr %3, align 4, !dbg !23
  %7 = load i32, ptr %3, align 4, !dbg !25
  %8 = call i32 @putchar(i32 noundef %7), !dbg !26
  %9 = icmp eq i32 %8, 66, !dbg !27
  %10 = zext i1 %9 to i64, !dbg !26
  %11 = select i1 %9, i32 0, i32 1, !dbg !26
  ret i32 %11, !dbg !28
}
...
!8 = !DIFile(filename: "samples/clang/optimized_smoke.c", directory: "/Users/yudai.takada/ydah/printf", checksumkind: CSK_MD5, checksum: "66c22a27fcf2e6725bb1e849c0011e92")
!9 = !{!10}
...
!21 = !DILocalVariable(name: "value", scope: !12, file: !8, line: 5, type: !22)
!22 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!23 = !DILocation(line: 5, column: 16, scope: !12)
!24 = !DILocation(line: 5, column: 24, scope: !12)
!25 = !DILocation(line: 6, column: 23, scope: !12)
!26 = !DILocation(line: 6, column: 10, scope: !12)
!27 = !DILocation(line: 6, column: 30, scope: !12)
!28 = !DILocation(line: 6, column: 3, scope: !12)
